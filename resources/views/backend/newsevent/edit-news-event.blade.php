                    ...
                    <form method="post" action="{{route('news_events.update', $editData->id)}}" id="myForm" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" id="datepicker"  value={{$editData->date}} name="date" class="form-control" placeholder="YYYY-MM-DD" readonly>
                            </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                <img id="showImage" src="{{!empty($editData->image)?url('public/upload/news_event_images/' . $editData->image):url('public/upload/noimage.png')}}" style=" width: 150px; height: 150px; border: 2px solid #000;">
                            </div>
                        </div>
