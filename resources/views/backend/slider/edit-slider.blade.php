                ...
                <section class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3>Edit Slider</h3>
                            <a class="btn btn-success float-right btn-sm" href="{{route('sliders.view')}}"><i class="fa fa-list"></i>Logo List</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                    ...
                    <form method="post" action="{{route('sliders.update',$editData->id)}}" id="myForm" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-2">
                                <img id="showImage" src="{{!empty($editData->image)?url('public/upload/slider_images/' . $editData->image):url('public/upload/noimage.png')}}" style=" width: 150px; height: 150px; border: 2px solid #000;">
                            </div>
                        </div>
