                ...
                <section class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            @endif
                            <a class="btn btn-success float-right btn-sm" href="{{route('colors.view')}}"><i class="fa fa-list"></i>Product Color List</a>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                    ...
                    <form method="post" action="{{(@$editData)?route('colors.update', $editData->id):route('colors.store')}}" id="myForm" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-8">
                                <label for="name">Product Color Name:</label>
                                <input type="text" name="name" value="{{@$editData->name}}" class="form-control" placeholder="Product Color Name....">
